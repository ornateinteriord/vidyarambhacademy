      ...
      <Container maxWidth="lg">
        <Grid container spacing={10} justifyContent="center">
          ...
          <Grid item xs={12} sm={4} >
            <Typography variant="h5" sx={{ color: 'black',fontWeight:'bold',marginBottom:'20px'}}>Little Stars Kindergarten</Typography>
        ...
        <div className="social-section">
          <Typography variant="h6" sx={{ color: 'black',fontWeight:'bold'}} >Follow Us</Typography>
